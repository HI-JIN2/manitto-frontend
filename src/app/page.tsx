...
export default function Home() {
  ...
  return (
    <div className="flex flex-col gap-8">
      <section className="overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-surface to-surface-2 px-10 py-12 shadow-2xl shadow-black/40">
        <div className="flex flex-col gap-4">
          ...
          <div className="max-w-3xl space-y-1 text-lg text-muted">
